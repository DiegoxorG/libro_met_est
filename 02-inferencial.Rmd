...
Con un punto por paciente las nubes son dispersas y ninguna muestra un patrón marcado. Se insinúan tendencias positivas con la edad, `PPE` y `RPDE` y, más leves, con los índices de inestabilidad y `NHR`; negativas con `HNR` y `DFA`. En `NHR`, `jitter` y `shimmer` unos pocos pacientes con valores muy altos quedan aislados a la derecha y pesan mucho en cualquier medida de asociación.
